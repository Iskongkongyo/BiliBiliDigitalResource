    ...
    <div class="container">
        <div class="panel">
            ...
            <div class="step-container">
                ...
                <div style="margin-top: 10px; text-align: right;"><button onclick="getVideos()">渲染视频与图片</button></div>
            </div>
        </div>
        <div id="result-panel" class="panel" style="display: none;">
            ...
            <div id="progress-container" class="progress-wrapper"><progress id="download-progress" max="100" value="0"></progress><div id="progressText">准备下载...</div></div>
        ...
        async function downloadFilesAsZip() {
            ...
            const downloadWorker = async () => {
                while (currentIndex < targetUrls.length) {
                    ...
                    const proxyUrl = targetUrls[index];
                    const originalUrl = targetData[index]?.originalUrl || proxyUrl;
